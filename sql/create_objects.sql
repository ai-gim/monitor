...
CREATE TABLE IF NOT EXISTS  `monitor_pkts_in` (
  `ip` VARCHAR(128) NULL,
  `value` FLOAT NULL,
  `unit` VARCHAR(128) NULL,
  `time` DATETIME NULL)
...
CREATE TABLE IF NOT EXISTS  `monitor_bytes_in` (
  `ip` VARCHAR(128) NULL,
  `value` FLOAT NULL,
  `unit` VARCHAR(128) NULL,
  `time` DATETIME NULL)
...
CREATE TABLE IF NOT EXISTS  `monitor_bytes_out` (
  `ip` VARCHAR(128) NULL,
  `value` FLOAT NULL,
  `unit` VARCHAR(128) NULL,
  `time` DATETIME NULL)
...
CREATE TABLE IF NOT EXISTS  `monitor_swap_total` (
  `ip` VARCHAR(128) NULL,
  `value` FLOAT NULL,
  `unit` VARCHAR(128) NULL,
  `time` DATETIME NULL)
...
CREATE TABLE IF NOT EXISTS  `monitor_part_max_used` (
  `ip` VARCHAR(128) NULL,
  `value` FLOAT NULL,
  `unit` VARCHAR(128) NULL,
  `time` DATETIME NULL)
...
CREATE TABLE IF NOT EXISTS  `monitor_pkts_out` (
  `ip` VARCHAR(128) NULL,
  `value` FLOAT NULL,
  `unit` VARCHAR(128) NULL,
  `time` DATETIME NULL)
...
CREATE TABLE IF NOT EXISTS  `monitor_swap_free` (
  `ip` VARCHAR(128) NULL,
  `value` FLOAT NULL,
  `unit` VARCHAR(128) NULL,
  `time` DATETIME NULL)
